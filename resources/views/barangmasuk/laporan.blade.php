...
<div class="w-full px-6 py-6">
    ...
    <div class="flex justify-between items-center mb-6 no-print">
        <h2 class="text-2xl font-black text-gray-800 uppercase tracking-tighter">
            Laporan <span class="text-blue-600">Barang Masuk</span>
        </h2>
        <div class="flex gap-3">
            <button onclick="window.print()" class="bg-blue-600 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:bg-blue-700 transition flex items-center gap-2">
                <i class="bi bi-printer-fill"></i> Cetak Laporan
            </button>
            <a href="{{ route('barangmasuk.index') }}" class="bg-gray-100 text-gray-600 px-6 py-3 rounded-xl font-bold hover:bg-gray-200 transition">
                Kembali
            </a>
        </div>
    </div>
    ...
    <div class="bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100 print:shadow-none print:border-none print:p-0">
        ...
        <div class="text-center border-b-4 border-gray-900 pb-6 mb-8">
            <h1 class="text-3xl font-black uppercase">Laporan Transaksi Barang Masuk</h1>
        ...
        <table class="w-full text-left border-collapse border border-gray-300">
            <thead>
                <tr class="bg-gray-100 print:bg-gray-200">
                    ...
                    <th class="border border-gray-300 px-4 py-3 text-xs font-black uppercase">Supplier</th>
            ...
            <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-50/50">
                    ...
                    <td class="border border-gray-300 px-4 py-2 text-sm text-center font-black text-green-600">
                    ...
                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-600">
                        {{ $item->user->username ?? 'User #'.$item->id_user }}
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<style>
    @media print {
        /* Sembunyikan elemen navigasi agar tidak ikut terprint */
