    ...
    <div class="bg-white p-10 rounded-3xl shadow-xl border border-gray-200 max-w-2xl mx-auto px-6 py-6">
        ...
        <div class="mb-8 py-4">
            <h2 class="text-3xl font-extrabold text-gray-900 flex items-center space-x-3">
                <i class="bi bi-person-fill-gear text-green-600 text-3xl"></i>
                <span>Edit Data User: <span class="text-indigo-600">{{ $user->username }}</span></span>
            </h2>

            <p class="text-gray-500 mt-2">
                Perbarui informasi user. Bagian password dapat dikosongkan.
            </p>
        </div>
        ...
        <form action="{{ route('user.update', $user->id_user) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select id="role" name="role" required
                    ...
                    {{-- Nilai default diambil dari $user->role --}}
            ...
            <h3 class="text-lg font-bold text-gray-800 mb-4">Perbarui Password (Opsional)</h3>
            ...
            {{-- BUTTONS --}}
            <div class="flex justify-end space-x-4 mb-4 pt-5">
